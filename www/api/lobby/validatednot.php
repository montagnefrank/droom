                    ...
                    <div class="list-unstyled member-list row">
                        <div class="col-lg-16 col-sm-16 col-xs-16 customCard validatedCard">
                            <div class="media flex-column ">
                                <figure class="background"><img class="d-flex mr-3" src="assets/img/danger.png" alt="Generic user image"></figure>
                                <span class="message_userpic large"><img class="d-flex mr-3" src="assets/img/danger.png"
                                        alt="Generic user image">
                                </span>
                                <div class="media-body">
                                    <h6 class="mt-0 mb-1">Error</h6>
                                    No pudimos Validar tu cuenta<br>
                                    <br>
                                    <button class="btn btn-info btn-round gohomeBtn">Intentar de Nuevo</button>
                                </div>
                            </div>
                        </div>
                    </div>
